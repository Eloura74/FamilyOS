  ...
  return (
    // ... (existing code)
        ...
        <button
          ...
          className="fixed bottom-20 right-6 p-4 bg-linear-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 text-white rounded-full shadow-lg shadow-blue-600/30 transition-all active:scale-95 z-50 border border-white/10"
        >
