...
export default function CalendarCard({
  ...
  return (
    ...
    >
      {/* Glow Effect */}
      <div className="absolute -inset-0.5 bg-linear-to-r from-indigo-500/20 to-violet-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl pointer-events-none rounded-3xl"></div>
      ...
      >
        <div className="flex items-center gap-4">
          <div className="h-12 w-12 rounded-2xl bg-linear-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-2xl text-white shadow-lg shadow-indigo-900/20 ring-1 ring-white/10">
            📅
          </div>
