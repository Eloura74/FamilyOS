...
export default function CalendarCard({
  ...
  return (
    ...
    >
      {/* Glow Effect */}
      <div className="absolute -inset-0.5 bg-linear-to-r from-indigo-500/20 to-violet-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl pointer-events-none"></div>
